                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('posts.update', $post) }}"> 
                        ...
                        <div class="mb-4">
                            ...
                            <input class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500 shadow-sm" type="text" name="title" value="{{ $post->title }}">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:border-blue-500 shadow-sm" name="content" id="content" required>{{ $post->content }}</textarea>
                        </div>
